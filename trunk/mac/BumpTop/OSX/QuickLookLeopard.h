...
#ifndef BUMPTOP_OSX_QUICKLOOKLEOPARD_H_
#define BUMPTOP_OSX_QUICKLOOKLEOPARD_H_
...
class LeopardQuickLookInterface : public QuickLookInterface {
 public:
  ...
  protected:
 NSArray* NSURLArrayFromQStringListPaths(QList<QString> paths);
};

 #endif  // BUMPTOP_OSX_QUICKLOOKLEOPARD_H_
