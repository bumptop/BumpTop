...
namespace LoginItems {
  void addOrRepairLoginItemIfRequired();
  void addBumpTopToLoginItems();
  void removeBumpTopFromLoginItems();
  void syncBumpTopShouldStartOnLoginWithSystemPreferences();
}

@interface ModifyLoginItems : NSObject {
}
