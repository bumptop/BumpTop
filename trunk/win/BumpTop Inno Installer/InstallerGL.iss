...
AppName=BumpTop
AppVerName=BumpTop
; *********************** DO NOT CHANGE THE VERSION FROM 0.0.1337 BELOW ***********************
...
OutputDir=.
OutputBaseFilename=BumpTopInstallerGL
...
Source: ..\Source\Release_GL\BumpTop-OpenGL.exe; DestDir: {app}; Flags: ignoreversion
...
[Icons]
Name: {group}\BumpTop; Filename: {app}\BumpTop-OpenGL.exe
; Name: "{group}\{cm:ProgramOnTheWeb,BumpTop}"; Filename: "http://www.bumptop.com/"
Name: {commondesktop}\BumpTop; Filename: {app}\BumpTop-OpenGL.exe
; Name: "{userappdata}\Microsoft\Internet Explorer\Quick Launch\BumpTop"; Filename: "{app}\BumpTop.exe"
Name: {commonstartup}\BumpTop; Filename: {app}\BumpTop-OpenGL.exe
...
[Run]
Filename: {app}\BumpTop-OpenGL.exe; Description: {cm:LaunchProgram,BumpTop}; Flags: nowait postinstall skipifsilent runasoriginaluser
...
begin
  ...
  begin
    ...
    KillProcess('BumpTop-OpenGL.exe');
...
begin
  ...
  begin
    ...
    Exec(ExpandConstant('{app}\BumpTop-OpenGL.exe'), '-sendUninstallStats', '', SW_SHOW, ewWaitUntilTerminated, ResultCode);
