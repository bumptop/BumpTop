...
AppVersion=2.5.6268
VersionInfoVersion=2.5.6268
OutputBaseFilename=BumpTop-2.5-6268
...
; runtimes
Source: ..\Source\Release\dxwebsetup.exe; DestDir: {app}; Flags: ignoreversion
Source: ..\Source\Release\D3DX9_41.dll; DestDir: {app}; Flags: ignoreversion
...
;Name: {group}\BumpTop (Enable Logging); Filename: {app}\BumpTop.exe; Parameters: -log -logIgnoreStartOrEnd; Languages:
...
begin
  ...
  begin
    ...
    Exec(ExpandConstant('{tmp}\dxwebsetup.exe'), '/q', '', SW_SHOW, ewWaitUntilTerminated, ResultCode);
  end;
end;
