...
Root: HKLM; Subkey: "SOFTWARE\ArcSoft\TotalMedia Center\1.0.2\Plugin\BumpTop"; ValueType: dword; ValueName: "ThirdParty"; ValueData: 1; Flags: createvalueifdoesntexist
Root: HKLM; Subkey: "SOFTWARE\ArcSoft\TotalMedia Center\1.0.2\Plugin\BumpTop"; ValueType: dword; ValueName: "AddedShell"; ValueData: 1; Flags: createvalueifdoesntexist
Root: HKLM; Subkey: "SOFTWARE\ArcSoft\TotalMedia Center\1.0.2\Plugin\BumpTop"; ValueType: string; ValueName: "IconPath"; ValueData:"{app}\bumptop.ico"; Flags: createvalueifdoesntexist
Root: HKLM; Subkey: "SOFTWARE\ArcSoft\TotalMedia Center\1.0.2\Plugin\BumpTop"; ValueType: string; ValueName: "PluginPath"; ValueData:"{app}\BumpTop.exe"; Flags: createvalueifdoesntexist
Root: HKLM; Subkey: "SOFTWARE\ArcSoft\TotalMedia Center\1.0.2\Plugin\BumpTop"; ValueType: string; ValueName: "PluginDescrp"; ValueData:"BumpTop 3D desktop"; Flags: createvalueifdoesntexist
