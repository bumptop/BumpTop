...
#ifndef _BT_LEAFING_GESTURE_
#define _BT_LEAFING_GESTURE_
...
class LeafingGesture : public Gesture
{
private:
	...
	static const float SLOW_SPEED_THRESHHOLD;
	Pile* _leafPile;
	Vec3 _startPoint;
	bool _startAtTop;
	int _leafIndex;
	Vec3 _leafPileCenter;
	bool _wasLastSpeedFast;
	ulong _lastTime;
