...
#ifndef _BT_PULL_DOWN_WALLS_GESTURE_
#define _BT_PULL_DOWN_WALLS_GESTURE_

#include "BT_Gesture.h"

class PullDownWallsGesture : public Gesture
{
private:
	int _wallNumber;
	bool _upDirection;
...
public:
	PullDownWallsGesture();
};

#endif /* _BT_PULL_DOWN_WALLS_GESTURE_ */