#ifndef _BT_WINDOWS7_COMMONCONTROLS_OVERRIDE_
#define _BT_WINDOWS7_COMMONCONTROLS_OVERRIDE_
...
typedef BOOL (__stdcall *TaskDialogIndirect)(const TASKDIALOGCONFIG *, int *, int *, BOOL *);
typedef BOOL (__stdcall *TaskDialog)(HWND, HINSTANCE, PCWSTR, PCWSTR, PCWSTR, TASKDIALOG_COMMON_BUTTON_FLAGS, PCWSTR, int *);

#endif // _BT_WINDOWS7_COMMONCONTROLS_OVERRIDE_