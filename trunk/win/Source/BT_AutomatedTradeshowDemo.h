...
#ifndef BT_AUTOMATETRADEDEMO
#define BT_AUTOMATETRADEDEMO
...
*/
class AutomatedTradeshowDemo : public Replayable
{
	Q_DECLARE_TR_FUNCTIONS(AutomatedTradeshowDemo)
